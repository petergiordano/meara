...
**YOUR TASK:**
Assemble a comprehensive, evidence-rich Marketing Effectiveness Analysis report (main body: 250-350 lines).

**CRITICAL REQUIREMENTS:**
- Include ALL evidence gathered with proper citations: 'Quote' [Source: URL, accessed YYYY-MM-DD]
- Provide 2-3 paragraphs of analysis per major section
- Use specific examples, URLs, dates, metrics throughout
- Professional, strategic, consultative tone
- DO NOT include the detailed 9-dimension rubric tables (handled by separate Table Generator agent)
...
## Executive Summary
[4-5 critical findings, each with:
...
**Note:** Detailed dimension analysis tables with sub-element ratings are generated separately by the Table Generator agent and will be appended as an appendix.
...
TARGET LENGTH: 250-350 lines (tables handled separately).""",
        "model": "gpt-4o",
        "temperature": 0.3,
        "tools": ["file_search"],
